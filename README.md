...
А также: Визуальное редактирование типов реквизитов,  отображение таблицы состава ролей, фильтр по подсистемам, визуальный редактор форм (прототип, идёт работа)
