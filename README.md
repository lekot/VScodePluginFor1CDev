...
А также: Визуальное редактирование типов реквизитов,  отображения ролей и их состава (без RLS и корня), визуальный редактор форм (багованный прототип, идёт работа)

Чего нет: конструктор запроса (пользуйтесь внешними в режиме предприятия), СКД-редактора (я не готов), (есть в бэклоге), редактирование состава подсистем (когда-то будет)
