...
Чтоб получить самый свежий релиз - качаем репу из девелоп - build-all.bat вернёт VSIX. В релизы не успеваю отстреливать прогресс
...
А также: Визуальное редактирование типов реквизитов,  отображения ролей и их состава, фильтр по подсистемам, визуальный редактор форм (багованный прототип, идёт работа)

Чего нет: конструктора запроса (есть внешние в режиме предприятия), СКД-редактора, редактирование состава подсистем (когда-то будет), просмотра макетов, состава планов обмена и много чего еще нет. Включайся в разработку - будет
