...
| CDT 41: Copy diagnostics summary | Сводка для багрепортов: версии, ОС (`process.platform`), язык UI (`vscode.env.language`), workspace, корни конфигурации (в буфер обмена) |
