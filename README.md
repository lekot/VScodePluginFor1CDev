...
| CDT 41: Copy diagnostics summary | Сводка для багрепортов: версии, хост-приложение (`vscode.env.appName`), ОС, язык UI, workspace, корни конфигурации (в буфер обмена) |
