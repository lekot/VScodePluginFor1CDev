...
| CDT 41: Показать активный файл в дереве метаданных | Как «Показать активный файл в представлении проводника» — в панели CDT 41, выделяет объект по открытому файлу (BSL, XML, форма и т.д.) |
