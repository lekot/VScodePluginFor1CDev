...
А также: Визуальное редактирование типов реквизитов,  отображения ролей и их состава (без RLS и корня, не нажимайте SAVE - сохранение багованое, в работе), визуальный редактор форм (багованный прототип, идёт работа)
