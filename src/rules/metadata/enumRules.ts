...
export const enumRules: MetadataObjectRules = {
    ...
    properties: {
        ...
        choiceMode: { type: 'SystemEnumeration', order: 5, xml: 'ChoiceMode', yaml: 'РежимВыбора', defaultValueXML: 'BothWays', typeSE: 'ChoiceMode' },
        ...
        quickChoice: { type: 'boolean', order: 13, xml: 'QuickChoice', yaml: 'БыстрыйВыбор', defaultValueXML: true },
        standardAttributes: { type: 'StandardAttributeDescriptions', order: 14, xml: 'StandardAttributes', defaultValueXML: undefined },
        synonym: { type: 'I8nText', order: 15, xml: 'Synonym', yaml: 'Синоним' },
