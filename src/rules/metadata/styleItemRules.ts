// src/rules/metadata/styleItemRules.ts
// Rules for StyleItem metadata object (Designer format).
import { MetadataObjectRules } from '../types';

export const styleItemRules: MetadataObjectRules = {
    rootTag: 'StyleItem',
    namespaces: {
    ...
    properties: {
        ...
        type: { type: 'SystemEnumeration', order: 4, xml: 'Type', yaml: 'Тип', defaultValueXML: 'Color', typeSE: 'StyleItemType' },
    },
};
