// src/rules/metadata/functionalOptionsParameterRules.ts
// Rules for FunctionalOptionsParameter metadata object (Designer format).
import { MetadataObjectRules } from '../types';

export const functionalOptionsParameterRules: MetadataObjectRules = {
    rootTag: 'FunctionalOptionsParameter',
    namespaces: {
