...
**Назначение:** краткая карта «что уже есть» для команды реализации и QA; функциональный разрыв с EDT — в [cdt-vs-edt-functional-gap.md](../research/cdt-vs-edt-functional-gap.md).
