export const coreSuiteFiles: string[] = [
  ...
  'suite/parentConfigurationsCodec.test.js',
  'suite/parentConfigurationsStore.test.js',
  'suite/metadataUniverseResolver.test.js',
  'suite/supportStateLifecycle.test.js',
  'suite/supportApplicationLifecycle.test.js',
  'suite/supportCapabilityRegistry.test.js',
  ...
  'suite/supportCommands.test.js',
  'suite/supportTreeDecorations.test.js',
  'suite/agentSupportOperations.test.js',
  'suite/agentDeployPartialResult.test.js',
  ...
  'suite/extensionManifestContracts.test.js',
  'suite/extensionActivationLifecycle.test.js',
  ...
  'suite/formEditorLifecycle.test.js',
  ...
  'suite/lazyWorkspaceOrchestrator.test.js',
...
'suite/subsystemCompositionRefResolver.test.js',
  ...
  'suite/cfeBorrow.test.js',
  'suite/cfeBorrowAdapters.test.js',
  'suite/cfeInterceptor.test.js',
  'suite/cfeForm.test.js',
  ...
  'suite/compareMerge/mergePlanner.bulk.test.js',
  'suite/compareMerge/mergeExecutor.test.js',
  'suite/compareMerge/mergeExecutor.xmlFileOps.test.js',
  ...
  'suite/compareMerge/configCompareProvider.bulk.test.js',
  'suite/compareMerge/configurationCompareCommands.test.js',
  'suite/compareMerge/configurationInventory.test.js',
  'suite/compareMerge/fileObjectAdapter.test.js',
  'suite/compareMerge/metadataXmlAdapter.test.js',
  'suite/compareMerge/formXmlAdapter.test.js',
  'suite/compareMerge/predefinedXmlAdapter.test.js',
  'suite/compareMerge/xmlDomDiffPatch.test.js',
